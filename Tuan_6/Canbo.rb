...
class CongNhan < CanBo
  ...
  def initialize(name_242, age_242, gnder, address_242, level_242)
    super(name_242, age_242, gnder, address_242)
    @level_242 = level_242
  end
...
class KySu < CanBo
  ...
  def initialize(name_242, age_242, gender_242, address_242, training_242)
    super(name_242, age_242, gender_242, address_242)
    @training_242 = training_242
  end
  ...
  def display
    super
    puts "Training_242: #{@training_242}"
  end
...
class NhanVien < CanBo
  ...
  def initialize(name_242, age_242, gender_242, address_242, work)
    super(name_242, age_242, gender_242, address_242)
    @work = work
  end
